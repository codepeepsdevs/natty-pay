  ...
  return (
    <div className="w-full  overflow-hidden flex justify-center bg-bg-800 dark:bg-black">
      <motion.div
        ...
        initial="hidden"
        className="w-full mt-36 xl:mt-48 2xl:mt-60 bg-bg-600 dark:bg-bg-1100 rounded-t-[4rem] 2xs:rounded-t-[5rem] xl:rounded-t-[6rem]  flex flex-col items-center h-full lg:py-12"
      >
