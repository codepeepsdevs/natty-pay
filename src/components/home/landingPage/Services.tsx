...
const Services = () => {
  ...
  return (
    ...
    >
      <div className="w-full flex flex-col items-center bg-secondary py-14 xs:py-20">
        <motion.div
          //   variants={textVariant(0.1)}
          className="w-[90%] xs:w-[80%] md:w-[70%] xl:w-[50%] flex flex-col gap-1.5 xs:gap-2.5 xl:gap-4 justify-center items-center text-center text-black"
        >
          <h1 className="text-3xl xs:text-4xl xl:text-5xl 2xl:text-6xl font-bold ">
            Our Services{" "}
          </h1>
      ...
      <div className="flex flex-col items-center py-12 sm:py-16 lg:py-20">
        <motion.div
          ...
          className="w-[90%] grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 xl:gap-5"
        >
