...
const Mission = () => {
  ...
  return (
    <div className="relative w-full flex justify-center bg-bg-1100 dark:bg-black">
      <motion.div
        ref={ref}
      ...
      >
        <div className="inset-0 mx-auto flex max-lg:flex-col-reverse lg:justify-between lg:items-center pt-8 lg:py-16 gap-10">
          <div className=" w-full lg:w-[60%] flex flex-col gap-6">
            ...
            >
              <h1 className="text-2xl 2xs:text-3xl xs:text-4xl  font-bold leading-[2.4rem] 2xs:leading-[2.8rem] xs:leading-[3.5rem] xl:leading-[4rem] 2xl:leading-[5rem]">
                Our Mission{" "}
              </h1>
              <p className="text-sm 2xs:text-base leading-[1.5rem] ">
