      ...
      <div className="relative w-full flex justify-center">
        ...
        >
          <div className="relative ">
            <div className="z-30 bg-bg-1100 dark:bg-bg-1900 w-full relative inset-0 mx-auto flex flex-col justify-center items-center pb-10 pt-32 sm:pb-12 sm:pt-36 md:pb-14 md:pt-40">
              <motion.div
                variants={textVariant(0.1)}
                className="w-[95%] 2xs:w-[90%] lg:w-[85%] 2xl:w-[70%] flex flex-col gap-3 xs:gap-1 text-center py-4"
              >
                <h1 className="text-text-900 dark:text-black text-2xl xs:text-3xl md:text-4xl xl:text-5xl font-medium xs:leading-[2.4rem] md:leading-[2.8rem] xl:leading-[3.8rem]">
                  Terms of Use{" "}
                </h1>

                <p className="text-sm xs:text-base sm:text-xl text-text-800 dark:text-text-700 font-medium">
          ...
          <div className=" flex flex-col items-center gap-12">
            <div className="w-[90%] lg:w-[88%] flex flex-col gap-10 text-base xs:text-lg text-text-200 dark:text-text-900">
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-4">
                  <p className="">
                    ...
                    and software, is the property of NATTYPAY GLOBAL SOLUTION
                    LIMITED (NATTYPAY) and is protected by intellectual property
                    laws. You may not use, copy, or distribute any content from
                    the Service without explicit permission from NATTYPAY GLOBAL
                    SOLUTION LIMITED (NATTYPAY)
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-4">
                  <p className="">
                        To the fullest extent permitted by law, NATTYPAY GLOBAL
                    SOLUTION LIMITED (NATTYPAY) and its affiliates are not
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <p>Email : support@nattypay.com</p>
                  <p>Call:+2348134146906</p>
                </div>
              </div>
            </div>
          </div>
