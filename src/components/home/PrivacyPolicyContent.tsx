        ...
        >
          <div className="relative ">
            <div className="z-30 bg-bg-1600 dark:bg-bg-1700 w-full relative inset-0 mx-auto flex flex-col justify-center items-center pb-10 pt-32 sm:pb-12 sm:pt-36 md:pb-14 md:pt-40">
              ...
              >
                <h1 className="text-text-1200 dark:text-text-900 text-2xl xs:text-3xl md:text-4xl xl:text-5xl font-bold xs:leading-[2.4rem] md:leading-[2.8rem] xl:leading-[3.8rem]">
                  NATTYPAY GLOBAL SOLUTION LIMITED (NATTYPAY){" "}
                </h1>
                <p className="text-secondary text-2xl lg:text-3xl xl:text-4xl font-medium ">
                  Privacy Policy{" "}
                </p>
                <p className="text-sm xs:text-base sm:text-xl text-text-1300 font-medium">
          ...
          <div className=" flex flex-col items-center gap-12">
            <div className="w-[90%] lg:w-[88%] flex flex-col gap-10 text-base xs:text-lg text-text-200 dark:text-text-900">
              <div className="flex flex-col gap-4">
                <h4 className="">
                  NATTYPAY GLOBAL SOLUTION LIMITED (NATTYPAY) we are committed
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <p className="">Email:support@nattypay.com</p>

                  <p className="">Call:+2348134146906</p>
                </div>
              </div>
            </div>
          </div>
