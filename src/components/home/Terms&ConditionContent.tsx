          ...
          <div className="relative inset-0 mx-auto flex flex-col justify-center items-center">
            ...
            >
              <h1 className="text-2xl xs:text-3xl md:text-4xl xl:text-5xl font-bold xs:leading-[2.4rem] md:leading-[2.8rem] xl:leading-[3.8rem]">
                WELCOME TO NATTYPAY GLOBAL SOLUTION LIMITED (NATTYPAY)
              </h1>
          ...
          <div className="w-full flex flex-col gap-12">
            <div className="flex flex-col gap-10 text-base xs:text-lg text-text-200 dark:text-text-900">
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-4">
                  <p className="">
                    3.1  describe of services & Features offered by NATTYPAY
                    GLOBAL SOLUTION LIMITED (NATTYPAY)   digital personal &
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-4">
                  <p className="">
                    ...
                    provided are owned by or licensed to NATTYPAY GLOBAL
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-4">
                  <p className="">
                    10.1 NATTYPAY GLOBAL SOLUTION LIMITED (NATTYPAY)  is not
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-4">
                  <p className="">
                    11.1 You agree to indemnify and hold harmless NATTYPAY
                    GLOBAL SOLUTION LIMITED (NATTYPAY)  from any claims,
