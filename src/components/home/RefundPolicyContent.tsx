      ...
      <div className="relative w-full flex justify-center">
        ...
        >
          <div className="relative ">
            <div className="z-30 bg-secondary  w-full relative inset-0 mx-auto flex flex-col justify-center items-center pb-10 pt-32 sm:pb-12 sm:pt-36 md:pb-14 md:pt-40">
              <motion.div
                variants={textVariant(0.1)}
                className="w-[95%] 2xs:w-[90%] lg:w-[85%] 2xl:w-[70%] flex flex-col gap-2 xs:gap-3 sm:gap-4 lg:gap-6 text-center py-4"
              >
                <h1 className="text-white text-2xl xs:text-3xl md:text-4xl xl:text-5xl font-bold xs:leading-[2.4rem] md:leading-[2.8rem] xl:leading-[3.8rem]">
                  NATTYPAY GLOBAL SOLUTION LIMITED (NATTYPAY){" "}
                </h1>
                <p className="text-black text-2xl lg:text-3xl xl:text-4xl font-medium ">
                  Refund Policy{" "}
                </p>
                <p className="text-sm xs:text-base sm:text-xl text-text-200 font-medium">
          ...
          <div className=" flex flex-col items-center gap-12">
            <div className="w-[90%] lg:w-[88%] flex flex-col gap-10 text-base xs:text-lg text-text-200 dark:text-text-900">
              <div className="flex flex-col gap-4">
                <h4 className="">
                  At NATTYPAY GLOBAL SOLUTION LIMITED (NATTYPAY) 
                </h4>
                <div className="flex flex-col gap-4">
                  <p className="">
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-4">
                  <p className="">
                    ...
                    Support@Nattypay.com or Call+2348134146906 within 24hour day
                    of the transaction.
                    <br />
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <p className="">
                    ...
                    team: Support@Nattypay.com or Call: +2348134146906
                    <br />
                    Head office: C3&C4 Suite Second Floor Ejison Plaza 9a new
