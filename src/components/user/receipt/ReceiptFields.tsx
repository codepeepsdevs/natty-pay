        ...
        <div className="flex flex-col py-8 px-8 gap-4 border-b border-dashed border-bg-11200">
          ...
          <div className="flex gap-8 text-xs text-white">
            <a
              ...
              href="https://www.nattypay.com/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <span className="text-lg">🌐</span>
              <span className="text-white">www.nattypay.com</span>
            </a>
            <a
              className="w-full flex items-center gap-2"
              href="mailto:info@nattypay.com"
              target="_blank"
              rel="noopener noreferrer"
            >
              <span className="text-lg">✉️</span>
              <span className="text-white">support@nattypay.com</span>
            </a>
            <a
              className="w-full flex items-center gap-2"
          ...
          {getTransactionDetails(transaction, fields)
            ...
            .map((detail, index) => (
              ...
              >
                ...
                {detail.isStatus ? (
                  <span
                    className={`${statusStyles.defaultReceipt} ${
      ...
      <div className="bg-white flex justify-center items-center py-16">
        <div className="w-[80%] text-center flex flex-col gap-4 justify-center items-center">
          ...
          <p className="text-base text-text-5700">
            Thank you for using NattyPay! For any inquiries, contact us at{" "}
            <a href="mailto:support@nattypay.com" className="text-primary">
